...
Route::middleware(['auth:sanctum', 'verified', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('series/{serie}/seasons', SeasonIndex::class)->name('season.index');
    Route::get('series/{serie}/seasons/{seasos}/episodes', EpisodeIndex::class)->name('episodes.index');
